...
assert.match(index,/js\/core\.js\?build=20260903c/,'recruitment rotation changes invalidate the cached core script');
assert.match(index,/js\/economy\.js\?build=20260903c/,'resource sale changes invalidate the cached economy script');
