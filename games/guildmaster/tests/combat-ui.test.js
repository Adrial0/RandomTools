...
assert.match(ui,/function combatBackgroundForMission\(/,'combat chooses the active area background for the battlefield');
assert.match(ui,/class="combatGrid combatBattlefield"/,'combatants render on a shared battlefield rather than separate card columns');
