...
function buyPrice(w){if(w.type==='rune')return 80;if(w.type==='gem')return 100*w.tier;const order=['basic','iron','fire','lightning','ice','heavy','poison','stun','heal','drain','steel'];return weaponPrice(w.priceIndex??Math.max(0,order.indexOf(w.id.split('-')[1])))}
